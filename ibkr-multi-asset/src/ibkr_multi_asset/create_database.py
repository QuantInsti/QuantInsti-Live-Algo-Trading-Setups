...
WORKBOOK_SCHEMAS = {
    ...
    'app_time_spent': ['datetime', 'Symbol', 'seconds', 'market_open_time', 'market_close_time'],
    'periods_traded': ['datetime', 'Symbol', 'trade_time', 'trade_done', 'market_open_time', 'market_close_time'],
    'account_updates': ['Symbol', 'key', 'Account', 'Value', 'Currency', 'datetime'],
    'account_summary': ['datetime', 'ReqId', 'Account', 'Tag', 'Value', 'Currency', 'market_open_time', 'market_close_time'],
    'account_update_times': ['datetime', 'Account', 'UpdateTime', 'market_open_time', 'market_close_time'],
    'contract_details': ['Symbol', 'SecType', 'Currency', 'Exchange', 'PrimaryExchange', 'LocalSymbol', 'ValidExchanges', 'TradingClass', 'MarketName', 'LongName', 'ConId', 'MinTick', 'Multiplier', 'TimeZoneId', 'OrderTypes', 'LiquidHours', 'TradingHours', 'datetime'],
    'ib_errors': ['Symbol', 'ReqId', 'Code', 'Message', 'datetime'],
    'runtime_audit': ['Symbol', 'event', 'detail', 'datetime'],
    'strategy_state': ['Symbol', 'Scope', 'StateKey', 'StateValue', 'datetime'],
}
