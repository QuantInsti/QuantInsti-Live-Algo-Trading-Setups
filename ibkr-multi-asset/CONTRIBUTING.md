# Contributing to IB Multi-Asset Trading Setup

Thank you for your interest in contributing to the IB Multi-Asset Trading Setup! This document provides guidelines and information for you.
...
1. **Clone the repository**
   ...
   cd Trading-setups/ibkr-multi-asset
   ```
...
```python
import pytest
from src.ibkr-multi-asset.trading_functions import calculate_position_size
...
Thank you for contributing to the IB Multi-Asset Trading Setup!
