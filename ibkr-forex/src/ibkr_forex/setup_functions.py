...
def strategy(app):
    ...
    try:
        ...
        return_variables_prepare = tf.get_return_variable_names(STRATEGY_FILE, "prepare_base_df")
    except FileNotFoundError:
        app.logging.error("strategy.py not found. Cannot inspect prepare_base_df.")
        print("Error: user_config/strategies/strategy.py not found.")
        return
        ...
        print("Error: Function prepare_base_df not found in user_config/strategies/strategy.py.")
        return
    ...
    if app.isConnected() and not base_df.empty:
        ...
        try:
            ...
            return_variables_signal = tf.get_return_variable_names(STRATEGY_FILE, "get_signal")
        except FileNotFoundError:
